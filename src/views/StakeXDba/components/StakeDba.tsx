...
const StakeDba: React.FC<StakeProps> = ({}) => {
  const tokenName = "DBA"
  ...
  const tokenBalance = useTokenBalance(contractAddresses.dba[3])
      ...
      <CardContent>
        <StyledCardContentInner>
          <StyledCardHeader>
            ...
            <Label text={`DBA Tokens Available`}/>
          </StyledCardHeader>
          <StyledCardActions>
            {!allowance.toNumber() ? (
              <Button
